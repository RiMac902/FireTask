...
@injectable
class GetBoardsUseCase implements UseCase<List<BoardEntity>, String> {
  final DashboardRepository _repository;

  GetBoardsUseCase(this._repository);

  @override
  Future<Either<Failure, List<BoardEntity>>> call(String projectId) {
    return _repository.getBoards(projectId);
  }
}
